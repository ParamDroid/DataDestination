...
#include "blacklist.h"
#include "pcap_dump.h"
// #include "ndpi_api.h" Not needed and ignored
#include "jni_utils.h"
#include "uid_resolver.h"
#include "/zdtun/third_party/uthash.h"
...
// uint16_t pd_ndpi2proto(ndpi_protocol proto); not needed
...
// Internals
//void init_ndpi_protocols_bitmask(ndpi_protocol_bitmask_struct_t *b); //not needed
